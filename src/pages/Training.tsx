      ...
      <section className="py-32 bg-saafe-blue relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none">
          <svg width="100%" height="100%" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 400L400 0" stroke="white" strokeWidth="1" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white/5 backdrop-blur-xl p-12 md:p-20 rounded-[4rem] border border-white/10"
          >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="bg-saafe-green/5 border-2 border-saafe-green/20 p-10 rounded-[3rem] flex flex-col md:flex-row items-center gap-8"
          >
