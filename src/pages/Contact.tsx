...
import { Phone, Mail, Instagram, Globe, Send, MessageCircle } from 'lucide-react';
            ...
            <div className="space-y-10">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500">saafe.bsb@gmail.com</p>
                </div>
              </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full px-6 py-4 bg-saafe-gray rounded-xl border-none focus:ring-2 focus:ring-saafe-green transition-all" placeholder="Seu nome completo" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-saafe-blue uppercase tracking-widest">E-mail</label>
                  <input type="email" className="w-full px-6 py-4 bg-saafe-gray rounded-xl border-none focus:ring-2 focus:ring-saafe-green transition-all" placeholder="seu@email.com" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-saafe-blue uppercase tracking-widest">Telefone</label>
                <input type="tel" className="w-full px-6 py-4 bg-saafe-gray rounded-xl border-none focus:ring-2 focus:ring-saafe-green transition-all" placeholder="(00) 00000-0000" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-saafe-blue uppercase tracking-widest">Mensagem</label>
                <textarea rows={5} className="w-full px-6 py-4 bg-saafe-gray rounded-xl border-none focus:ring-2 focus:ring-saafe-green transition-all resize-none" placeholder="Como podemos ajudar no seu projeto?"></textarea>
              </div>
              <button type="submit" className="btn-primary w-full flex items-center justify-center gap-2 py-5 text-lg">
